...
export const PharmacyDashboardLayout: React.FC = () => {
  const [mobileSidebarOpen, setMobileSidebarOpen] = useState(false);

  return (
    <div className="h-screen bg-slate-100 flex font-sans text-slate-800 overflow-hidden">
      {/* Pharmacy Navigation Sidebar */}
      <PharmacySidebar mobileOpen={mobileSidebarOpen} setMobileOpen={setMobileSidebarOpen} />
